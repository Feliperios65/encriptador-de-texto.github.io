...
const boton_copiar = document.getElementById('boton');
...
btn_encriptar.addEventListener('click', function(){// se le asigna el vento click al boton
    ...
    txt_encriptado.textContent = encriptar(textarea);//imprimir en txt_encriptado el retorno de la funcion llamada
    boton_copiar.classList.remove('btn_copiar')
})
btn_desencriptar.addEventListener('click', function(){// se le asigna el evento click al boton
    const textarea = document.querySelector("textarea").value;//traemos el value del textarea
    txt_encriptado.classList.add('txt_encriptado');//clase para dar estilo donde aparece el texto encriptado
    txt_encriptado.textContent = desencriptar(textarea);//imprimir en txt_encriptado el retorno de la funcion llamada
    boton_copiar.classList.remove('btn_copiar')
})
...
boton_copiar.addEventListener('click', function(){
    navigator.clipboard.writeText(txt_encriptado.textContent)
